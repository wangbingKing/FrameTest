...
public class FutureRestApiV1 implements IFutureRestApi {
	 ...
	 * 期货行情URL
	 */
	private final  String FUTURE_TICKER_URL = "/api/v1/ticker.do";
	/**
	 * 期货指数查询URL
	 */
	private final String FUTURE_INDEX_URL = "/api/v1/index.do";

	/**
	 * 期货交易记录查询URL
	 */
	private final  String FUTURE_TRADES_URL = "/api/v1/trades.do";

	/**
	 * 期货市场深度查询URL
	 */
	private final String FUTURE_DEPTH_URL = "/api/v1/depth.do";
	/**
	 * 美元-人民币汇率查询URL
	 */
	 ...
	 * 期货取消订单URL
	 */
	private final  String FUTURE_CANCEL_URL = "/api/v1/cancel.do";

	/**
	 * 期货下单URL
	 */
	private final  String FUTURE_TRADE_URL = "/api/v1/trade.do";

	/**
	 * 期货账户信息URL
	 */
	private final String FUTURE_USERINFO_URL = "/api/v1/userinfo.do";
	
	/**
	 * 逐仓期货账户信息URL
	 */
	private final String FUTURE_USERINFO_4FIX_URL = "/api/v1/userinfo_4fix.do";

	/**
	 * 期货持仓查询URL
	 */
	private final String FUTURE_POSITION_URL = "/api/v1/position.do";
	
	/**
	 * 期货逐仓持仓查询URL
	 */
	private final String FUTURE_POSITION_4FIX_URL = "/api/v1/position_4fix.do"; 
...
//		param = MD5Util.buildMysign(map, this.secret_key);
//		String str = "sign="+param;
