...
public class PtJPanel extends javax.swing.JPanel implements BaseNode{
    ...
    public void updateOkCoinCn(ModelBase medol)
    {
    	OkCoinCnData medelData = (OkCoinCnData)medol;
         ...
         sellPanel1.id.setText("卖一");
         sellPanel1.value.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 5).value+"");
         sellPanel1.num.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 5).num+"");

         sellPanel2.id.setText("卖二");
         sellPanel2.value.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 4).value+"");
         sellPanel2.num.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 4).num+"");

         sellPanel3.id.setText("卖三");
         sellPanel3.value.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 3).value+"");
         sellPanel3.num.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 3).num+"");

         sellPanel4.id.setText("卖四");
         sellPanel4.value.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 2).value+"");
         sellPanel4.num.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 2).num+"");

         sellPanel5.id.setText("卖五");
         sellPanel5.value.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 1).value+"");
         sellPanel5.num.setText(medelData.verTickerSellData.get(medelData.verTickerSellData.size() - 1).num+"");
    }
