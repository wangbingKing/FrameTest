 ...
 */
public class HoldOrderListFrame extends javax.swing.JFrame {

    /**
     * Creates new form HoldOrderListFrame
     */
    public HoldOrderListFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoldOrderListFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoldOrderListFrame().setVisible(true);
            }
        });
    }
